...
import io.cloudstate.protocol.EntityDiscoveryPowerApi;

import static io.cloudstate.protocol.EntityDiscovery.Serializers.*;


public class EntityDiscoveryPowerApiHandlerFactory {
   ...
   * several services.
   */
  public static Function<HttpRequest, CompletionStage<HttpResponse>> create(EntityDiscoveryPowerApi implementation, Materializer mat, ActorSystem system) {
   ...
   * several services.
   */
  public static Function<HttpRequest, CompletionStage<HttpResponse>> create(EntityDiscoveryPowerApi implementation, Materializer mat, Function<ActorSystem, Function<Throwable, io.grpc.Status>> eHandler, ActorSystem system) {
   ...
   */
  public static Function<HttpRequest, CompletionStage<HttpResponse>> create(EntityDiscoveryPowerApi implementation, String prefix, Materializer mat, ActorSystem system) {
   ...
   * Registering a gRPC service under a custom prefix is not widely supported and strongly discouraged by the specification.
   */
  public static Function<HttpRequest, CompletionStage<HttpResponse>> create(EntityDiscoveryPowerApi implementation, String prefix, Materializer mat, Function<ActorSystem, Function<Throwable, io.grpc.Status>> eHandler, ActorSystem system) {
   ...
   */
  public static Function<HttpRequest, CompletionStage<HttpResponse>> partial(EntityDiscoveryPowerApi implementation, String prefix, Materializer mat, ActorSystem system) {
    return partial(implementation, prefix, mat, GrpcExceptionHandler.defaultMapper(), system);
  }
   ...
   * Use `akka.grpc.javadsl.ServiceHandler.concatOrNotFound` when combining several services.
   */
  public static Function<HttpRequest, CompletionStage<HttpResponse>> partial(EntityDiscoveryPowerApi implementation, String prefix, Materializer mat, Function<ActorSystem, Function<Throwable, io.grpc.Status>> eHandler, ActorSystem system) {
    return (req -> {
  ...
  private static CompletionStage<HttpResponse> handle(HttpRequest request, String method, EntityDiscoveryPowerApi implementation, Materializer mat, Function<ActorSystem, Function<Throwable, io.grpc.Status>> eHandler, ActorSystem system) {
    ...
    switch(method) {
      ...
      case "discover":
        return GrpcMarshalling.unmarshal(request, ProxyInfoSerializer, mat)
          .thenCompose(e -> implementation.discover(e, metadata))
      ...
      case "reportError":
        return GrpcMarshalling.unmarshal(request, UserFunctionErrorSerializer, mat)
          .thenCompose(e -> implementation.reportError(e, metadata))
